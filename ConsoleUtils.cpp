...
void SelectBackColour(int colour)
{
	...
	switch (colour)
	{
		...
		case clPurple: backColour = BACKGROUND_INTENSITY | BACKGROUND_BLUE | BACKGROUND_RED; break;
...
void SelectTextColour(int colour)
{
	...
	switch (colour)
	{
		...
		case clPurple: textColour = FOREGROUND_INTENSITY | FOREGROUND_BLUE | FOREGROUND_RED; break;
